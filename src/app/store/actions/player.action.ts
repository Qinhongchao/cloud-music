...
import { CurrentAction } from '../reducers/player.reducer';
...
export const SetCurrentAction=createAction('[player] set currentAction',props<{currentAction:CurrentAction}>())
